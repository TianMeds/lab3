                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Discord Bot</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/DiscordWebsite/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Web Development & Software Development</h6>
                                          </div>
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">26 March 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">My project for the Online Replit Hackathon was the Discord Bot. This is done using the Python language and Procfile, and it will run continuously for 24 hours.</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://bit.ly/3yfkz2u">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3MjIaFb">
                                </div>
                              </div>
                        </div>
                  </div>

                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Research Title Generator</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/ResearchTitleGenerator/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">5 June 2022</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">11 June 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">Research Title Generator for SHS Students to use in their Research Titles, similar to the Capstone Generator, except this will be available for all strands to use to generate ideas. </p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://bit.ly/3C3YcOB">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3CxSI06">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3C3YbKp">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3Cxlu0T">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3EnAdMS">
                              </div>
                        </div>
                  </div>
            </div>

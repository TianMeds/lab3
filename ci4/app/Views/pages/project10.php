                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Digital Clock Website</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/DigitalClock/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">01 March 2022</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">12 March 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This Digital clock is also a side project for enhancing my JavaScript skills and also my front end skills</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/tianmeds.github.io_DigitalClock_.png">
                                </div>
                                <div class="box">
                                    <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/tianmeds.github.io_DigitalClock_%20(1).png">
                                </div>

                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Capstone Title Generator</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/Capstone-Generator/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">10 June 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">Capstone title generator is created for Computer related course to help college to brainstorm their title for their capstone</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://bit.ly/3SFyzdZ">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3C6kgrU">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3Sygezj">
                                </div>
                              </div>
                        </div>
                  </div>

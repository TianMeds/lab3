                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Portfolio Website</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">5 August 2022</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">27 August 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This website is created with no prior exprience in searching for some solution but it fails in developing in terms of the media queries but it developed the backend of Email and Minimalist Design with help of JavaScript</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://bit.ly/3rr1mHe">
                                </div>
                                <div class="box">
                                    <img src ="https://bit.ly/3SACb0V">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3V329vq">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3ydwTjO">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3SOCnco">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3C6s3px">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3rrvNwP">
                                </div>
                                <div class="box">
                                    <img src = "https://bit.ly/3ruzAts">
                                </div>
                              </div>
                        </div>
                  </div>

                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Todo List App</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/todo-list/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">12 November 2022</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">20 November 2022</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This Todo List App is created first thru Figma making the UI in different devices of it and Next is We developed it like on the UI This also make me learn new things in JavaScript enhancing my skills more</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/image_2022-11-29_114131758.png">
                                </div>
                                <div class="box">

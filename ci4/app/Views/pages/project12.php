                  ...
                  <div class="hero-content">
                        ...
                        <div class="row">
                              <div class="col-lg-12">
                                    ...
                                    <h1 class="wow fadeInUp" data-wow-delay="1s">Weather App</h1>
                                    
                                    <div class="wow fadeInUp project-link" data-wow-delay="1.1s">
                                          <a href="https://tianmeds.github.io/weather-web-api/">Project Access here</a></h6>
                                    </div>
                                    ...
                                    <div class="row">
                                          <div class="col-lg-4">
                                                ...
                                                <h6 class="wow fadeInUp" data-wow-delay="1.3s">Side Project</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.4s">started :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.5s">21 January 2023</h6>
                                          </div>

                                          <div class="col-lg-4">
                                                <p class="wow fadeInUp" data-wow-delay="1.6s">completed :</p>
                                                <h6 class="wow fadeInUp" data-wow-delay="1.7s">February 1 2023</h6>
                                          </div>
                                    </div>
                                    <br>
                                    <p class="wow fadeInUp" data-wow-delay="1.8s">This Weather app is created as a side project and we use an API which weatherman.org to help us fetch some of the information. We used HTML CSS and JavaScript</p>
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="container">
                        ...
                        <div class="row">
                              <div class="wow fadeInUp image_div" id="SecondWeb" data-wow-delay="1.9s" >
                                <div class="box">
                                    <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/image_2023-02-12_130807760.png">
                                </div>
                                <div class="box">
                                    <img src ="https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/WeatherMockup.jpg">
                                </div>
                                <div class="box">
                                    <img src = "https://raw.githubusercontent.com/TianMeds/image--stocks-for-coding/main/Mockup-Weather.jpg">
                                </div>
